...
/**
 * Created by 희준 on 2016-08-03.
 */
public class Blutooth_client {



    static final private String SERIAL_UUID = "00001101-0000-1000-8000-00805F9B34FB";
    static private Blutooth_client sThis = null;
     ...
     */
    public static Blutooth_client getInstance() {
        if(sThis == null) {
            sThis = new Blutooth_client();
        }
    ...
    public abstract static class BluetoothStreamingHandler {
        ...
        public final boolean close() {
            Blutooth_client btSet = getInstance();
            if(btSet != null)
                return btSet.close();
            return false;
        }
